...
Suite* oft_suite(void) {
  Suite* suite = suite_create("oft");

  TCase* get_tcase = tcase_create("get");
  tcase_add_test(get_tcase, test_oft_insert_vals);
  tcase_add_test(get_tcase, test_oft_insert_lookup);
  tcase_add_test(get_tcase, test_oft_insert_lookup_vals);
  tcase_add_test(get_tcase, test_oft_insert_size);
  tcase_add_test(get_tcase, test_oft_insert_lookup_refcount);
  tcase_add_test(get_tcase, test_oft_insert_multi);
  tcase_add_test(get_tcase, test_oft_insert_multi_same_bucket);
  tcase_add_test(get_tcase, test_oft_insert_multi_size);
  tcase_add_test(get_tcase, test_oft_lookup_multi_same_bucket);
  suite_add_tcase(suite, get_tcase);

  TCase* rehash_tcase = tcase_create("rehash");
  ...
  tcase_add_test(remove_tcase, test_oft_remove_invalid);
  tcase_add_test(remove_tcase, test_oft_remove_size);
  tcase_add_test(remove_tcase, test_oft_release_decref);
  tcase_add_test(remove_tcase, test_oft_remove_bucket_head);
  tcase_add_test(remove_tcase, test_oft_remove_bucket_mid);
  tcase_add_test(remove_tcase, test_oft_remove_bucket_tail);
  tcase_add_test(remove_tcase, test_oft_remove_other_bucket);
  suite_add_tcase(suite, remove_tcase);
